...
You do not need to be an SDL expert or a graphics programmer. The same ideas show up in many GUI and game-like apps: an entry point, a model, a view, and a timed loop that updates an angle then redraws.
