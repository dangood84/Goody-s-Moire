...
procedure DrawText(Pixels: PLongWord; Width, Height: Integer; X, Y: Integer;
  const Text: string; Color: LongWord; Scale: Integer = 1);
...
procedure Plot(Pixels: PLongWord; Width, Height, X, Y: Integer; Color: LongWord);
begin
...
procedure DrawText(Pixels: PLongWord; Width, Height: Integer; X, Y: Integer;
  const Text: string; Color: LongWord; Scale: Integer);
var
        ...
        if (Glyph[Row] and (1 shl Col)) <> 0 then
          for SY := 0 to Scale - 1 do
            ...
            begin
              ...
              PY := Y + Row * Scale + SY;
              Plot(Pixels, Width, Height, PX, PY, Color);
            end;
  end;
end;
